<template>
   <el-dialog width="1200px" v-model="dialogTableVisible" lock-scroll destroy-on-close :show-close="!formShow" @close="formShow=false">
      ...
      <div class="form" v-show="formShow">
        ...
        <ContactForm sumbitBtnText="提交并下载" txt="我们注重客户隐私保密，且希望能帮助您了解该产品！" :sumbit="sumbit" />
