...
<div class="home-banner">
 <div class="banner-item">
  ...
  <div class="text">
    ...
    <div class="more-link">
      <a href="javascript:;" @click="dialogshow=true;proItem={product_name: '1500 A2 XY', detail_pdf: 'jingjiegongzt.pdf'}">进一步了解&nbsp;&nbsp;></a>
  ...
  <div class="text">
    ...
    <div class="more-link">
      <a href="javascript:;" @click="dialogshow=true;proItem={product_name: 'QuantStudioTM', detail_pdf: 'QuantStudio_1.pdf'}">进一步了解&nbsp;&nbsp;></a>
...
<div class="products">
  <div class="product-item"  v-for="(item, index) in productMsg" :key="index">
      <div class="text">
        ...
        <p>{{item.msg}}</p>
        <div class="more-link">
          <a @click="dialogshow=true;proItem=item" href="javascript:;">进一步了解&nbsp;&nbsp; ></a>
...
<div class="team">
 <div class="container">
   <a :href="teamlinks[index]" target="_blank" class="team-item" v-for="(item, index) in 8" :key="index">
...
const newsMsg = [
  {
    id: 1,
    time: '2022.12.24',
    title: '风雨同舟，感恩九年，迎接十年！',
    img: '/news/new1/img1-1.jpg',
    "mtime": "<span>24</span><span>2022.12</span>",
    content: '      时光荏苒，岁月如梭，九年只是历史长河中的一刹那，却是那么的波澜壮阔。九年，给我们留下了宝贵的财富；九年，给我们留下了厚重的责任；九年，见证了昨日的栉风沐雨；九年，守望着明天的灿烂辉煌。富途锐在2013年成立的时候,还很小很小;到2022年,富途锐已经迈入第九个年头,我们长高了,长壮了。'
  },
  {
    id: 2,
    time: '2022.10.24',
    title: '富途锐祝广东省医学会第七次医院科研实验室建设与管理学学术会议圆满成功',
    img: '/news/new2/img2-1.jpg',
    "mtime": "<span>24</span><span>2022.10</span>",
    content: '2022年10月21－22日，由广东省医学会主办、广东省医学会医学科研实验室建设与管理学分会承办、广东省人民医院协办的广东省医学会第七次医学科研实验室建设与管理学学术会议在肇庆市喜来登酒店成功举办。在疫情不稳的情况下，依然有来自省内各地医院、高校科研实验室的115名代表参加本次会议。'
  },
  {
    id: 3,
    time: '2022.5.22',
    title: '富途锐祝广东省医院科研实验室建设与管理专委会2022年学术年会圆满召开',
    img: '/news/new3/img3-1.jpg',
    "mtime": "<span>22</span><span>2022.5</span>",
    content: '      由广东省医院协会主办的医院科研实验室建设与管理专业委员会2022年学术年会暨青年论坛、医院科研实验室规范化管理培训班于2022年5月20－21日在广州市香岚官洲酒店召开。此次会议由医院科研实验室建设与管理专业委员会承办、南方医科大学南方医院协办，来自省内各医院科研实验室的百余名代表参加了会议。'
  }
]
</script>
